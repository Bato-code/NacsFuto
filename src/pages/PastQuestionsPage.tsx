  ...
  return (
    <div className="max-w-6xl mx-auto px-4 py-8">
      ...
      <div className="glass-card p-3 sm:p-4 mb-6 flex flex-col sm:flex-row gap-3 flex-wrap">
        ...
        <div className="input-icon-wrap flex-1 min-w-40">
          <Search className="input-icon" />
          <input className="cyber-input" placeholder="Search by Course Code or Title" value={courseCode} onChange={e => setCourseCode(e.target.value)} />
        </div>
      </div>
